...
if OS.mac?
  url "https://github.com/aws/eks-anywhere/releases/download/v0.10.1/eksctl-anywhere-v0.10.1-darwin-amd64.tar.gz"
  sha256 "c8f2770b6a2785bea4bb14321d3974e4ea7aa9867acbd379c549c73f6ddfc120"
end

if OS.linux?
  url "https://github.com/aws/eks-anywhere/releases/download/v0.10.1/eksctl-anywhere-v0.10.1-linux-amd64.tar.gz"
